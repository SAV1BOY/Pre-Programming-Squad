# Critical Risk Mitigation Gate

## Propósito
Verificar se todos os riscos críticos têm plano de mitigação.
...
## Como Verificar
Verificar risk register, confirmar mitigações para riscos críticos, validar rollback strategy.

## Evidências Necessárias
Risk register com probabilidade × impacto, mitigação documentada, rollback testado em staging.
...
Risco de API de terceiro ignorado → API caiu por 4h → sem fallback → downtime completo.

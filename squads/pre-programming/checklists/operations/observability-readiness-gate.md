...
## Propósito
Verificar se observabilidade está planejada (logs, métricas, tracing).
...
## Como Verificar
Verificar observability plan, confirmar incident response, validar deployment strategy.

## Evidências Necessárias
Observability plan, runbooks draft, deployment strategy documented.
...
Sem logging estruturado → bug em produção leva 4h para diagnosticar em vez de 15min.
